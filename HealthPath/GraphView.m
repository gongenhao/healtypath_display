...
- (void)generateData
{
    ...
    for (NSString *date in dates) {
        ...
        for (NSString *set in sets) {
            NSNumber *num = [NSNumber numberWithDouble:(60.0+arc4random_uniform(40))];
...
- (void)generateLayout
{
	...
	plotSpace.yRange                = [CPTPlotRange plotRangeWithLocation:CPTDecimalFromInt(0) 
                                                                   length:CPTDecimalFromInt(100 * sets.count)];
